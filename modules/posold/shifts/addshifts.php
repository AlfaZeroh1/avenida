...
<form class="forms" id="theform" action="addshifts_proc.php" name="shifts" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" name="starttime" id="starttime" class="date_input" size="12" readonly  value="<?php echo $obj->starttime; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
		<td align="right">End Date : </td>
		<td><input type="text" name="enddate" id="enddate" class="date_input" size="12" readonly  value="<?php echo $obj->enddate; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
