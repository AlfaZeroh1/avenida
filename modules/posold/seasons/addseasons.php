...
<form  id="theform" action="addseasons_proc.php" name="seasons" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" name="start" id="start" class="date_input" size="12" readonly  value="<?php echo $obj->start; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
		<td align="right">Ends : </td>
		<td><input type="text" name="end" id="end" class="date_input" size="12" readonly  value="<?php echo $obj->end; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
