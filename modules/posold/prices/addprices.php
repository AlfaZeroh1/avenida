<title>WiseDigits ERP: Prices </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addprices_proc.php" name="prices" method="POST" enctype="multipart/form-data">
