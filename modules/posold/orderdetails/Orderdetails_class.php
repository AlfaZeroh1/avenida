...
{				
	...
	function setObject($obj){
		...
		$this->brancheid2=str_replace("'","\'",$obj->brancheid2);
	...
	function add($obj,$shop){
		...
		while($i<$num){
			...
			if($orderdetailsDBO->persist($ob)){		
				...
				$query="update inv_branchstocks set quantity=(quantity-$obj->quantity) where itemid='$obj->itemid' and brancheid='$obj->brancheid'";
				mysql_query($query);
