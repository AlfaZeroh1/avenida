<title>WiseDigits ERP: Invoiceconsumables </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addinvoiceconsumables_proc.php" name="invoiceconsumables" method="POST" enctype="multipart/form-data">
