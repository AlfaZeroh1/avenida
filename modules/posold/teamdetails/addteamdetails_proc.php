...
if(!empty($id)){
	...
	if($ob->cashier==1)
	  $where=" where pos_teamdetails.id in($id) and pos_orders.brancheid2='$ob->brancheid2'  and pos_teamdetails.employeeid='$ob->employeeid' ";
	else
	  $where=" where pos_teamdetails.id in($id) and pos_orders.brancheid2='$ob->brancheid2'  ";
