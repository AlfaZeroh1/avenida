<title>WiseDigits ERP: Subdivides </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addsubdivides_proc.php" name="subdivides" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">New Item : </td>
			<td><select name="newitemid" class="selectbox">
<option value="">Select...</option>
<?php
	$items2=new Items2();
	$where="  ";
	...
	while($rw=mysql_fetch_object($items2->result)){
	?>
		<option value="<?php echo $rw->id; ?>" <?php if($obj->newitemid==$rw->id){echo "selected";}?>><?php echo initialCap($rw->name);?></option>
	<?php
	}
	?>
</select><font color='red'>*</font>
	...
	<tr>
		<td align="right">Subdivided On : </td>
		<td><input type="text" name="subdividedon" id="subdividedon" class="date_input" size="12" readonly  value="<?php echo $obj->subdividedon; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
