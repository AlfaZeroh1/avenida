...
if(existsRule($auth)){
?>
<div style="float:left;" class="buttons"> <input  class="btn btn-info" onclick="showPopWin('additems_proc.php',600,430);" value="Add Items " type="button"/></div>
<?php }?>

<form action="items.php" method="post">
<table>
  <tr>
    <td>Status: <select name="itemstatusid" class="selectbox">
...
<?php
    ...
    <td>
		<input type="submit" class="btn btn-primary" name="action" value="Filter"/></td>
  </tr>
</table>
</form>
...
<tr>
<td width="100%" align="center"><input onclick="stocktake();" type="submit" class="btn btn-danger" name="action" id="action" value="Stock Take" />
  <?php echo $error; ?></td>
</tr>
</table>
</form>
...
<?php } ?>
	...
	<?php
		...
		$groupby="";
		$orderby="";
		$where=" where pos_items.itemstatusid='$obj->itemstatusid' ";
...
if(existsRule($auth)){
?>
			<td><a href="javascript:;" onclick="showPopWin('additems_proc.php?id=<?php echo $row->id; ?>',600,430);"><img src='../../../dmodal/view.png' alt='view' title='view' /></a></td>
<?php
}
//Authorization.
$auth->roleid="2163";//View
