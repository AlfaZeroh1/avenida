<title>WiseDigits: Departmentcategorys </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="adddepartmentcategorys_proc.php" name="departmentcategorys" method="POST" enctype="multipart/form-data">
