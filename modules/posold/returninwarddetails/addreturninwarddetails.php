<title>WiseDigits ERP: Returninwarddetails </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addreturninwarddetails_proc.php" name="returninwarddetails" method="POST" enctype="multipart/form-data">
	<table width="100%" class="titems gridd" border="0" align="center" cellpadding="2" cellspacing="0" id="tblSample">
 <?php if(!empty($obj->retrieve)){?>
	<tr>
		<td colspan="4" align="center"><input type="hidden" name="retrieve" value="<?php echo $obj->retrieve; ?>"/>Document No:<input type="text" size="4" name="returninwardno"/>&nbsp;<input type="submit" name="action" value="Filter"/></td>
	</tr>
	<?php }?>
	<tr>
	...
	<tr>
		<td align="right">Returninward : </td>
			<td><select name="returninwardid" class="selectbox">
...
<?php
	...
	while($rw=mysql_fetch_object($returninwards->result)){
	?>
		<option value="<?php echo $rw->id; ?>" <?php if($obj->returninwardid==$rw->id){echo "selected";}?>><?php echo initialCap($rw->name);?></option>
	<?php
	}
	?>
