...
<form class="forms" id="theform" action="addbranchteams_proc.php" name="branchteams" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Location : </td>
			<td><select name="brancheid" class="selectbox" required>
...
<?php
	...
	<tr>
		<td align="right"> Team Role: </td>
			<td><select name="teamroleid" class="selectbox" required>
<option value="">Select...</option>
<?php
	...
	<tr>
		...
		<td><input type="text" name="number" id="number" value="<?php echo $obj->number; ?>" required/></td>
	</tr>
	<tr>
