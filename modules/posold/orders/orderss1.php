...
// 		  $where.=" and pos_orders.shiftid in($obj->shiftid) ";
		...
		$having="";
		$groupby=" group by pos_orders.tableno, pos_orders.billno ";
...
// 		  $where.=" and pos_orders.status=1 ";
	...
	?>
		<tr style="color:<?php echo $color; ?>">
			...
			<td><a onclick="showPopWin('orders.php?tableno=<?php echo $row->tableno; ?>&pop=1&orderedon=<?php echo $obj->orderedon; ?>&orderno=<?php echo $row->orderno; ?>&orderid=<?php echo $row->id; ?>',700,630);" href="javascript:;"><?php echo strtoupper($row->tableno); ?></a></td>
