<title>WiseDigits ERP: Customerpayments </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addcustomerpayments_proc.php" name="customerpayments" method="POST" enctype="multipart/form-data">
