...
$fields="crm_customers.name, crm_customers.address, crm_customers.flo, case when crm_customers.customerid is not null then customers.name else crm_customers.name end parent, case when crm_customers.customerid is not null then customers.address else crm_customers.address end parentaddress, crm_customers.code,pos_freights.name freightid, crm_agents.name agentid, crm_agents.address agentaddress, sys_currencys.name currencyid, sys_currencys.id currency";
...
<tr>
<div style="font-size:10px !important;"><strong>Payment Details:</strong> All Payments are to be borne by: <?php echo strtoupper($customers->name); ?></div><br/>
<div style="font-size:10px !important;"><strong>Payment Terms:<?php echo $paymentterms; ?>&nbsp;<?php echo $configaccounts->name; ?>&nbsp;<?php echo $configaccounts->accno; ?></div><br/>
</tr>
<tr>

<div style="font-size:10px !important;text-align:center;"><?php echo $declaration; ?></div><br/><br/>
<div style="font-size:10px !important;">Date and Place:........................................................signature:....................................Stamp....................................</div><br/>
<div style="font-size:10px !important;">Signed:....................................</div><br/>
