...
//
if(!empty($ob->parent))
  $where=" where pos_invoices.customerid in(select id from crm_customers where customerid='$customerid' and soldon='$invoicedon') or (pos_invoices.customerid='$customerid' and soldon='$invoicedon')";
else
