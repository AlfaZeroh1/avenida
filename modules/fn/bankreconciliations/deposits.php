...
{
	if(empty($obj->accid)){
	  $error="must give office control account";
	}
	elseif($obj->bankid=="Select...")
	{
	...
	else
	{
		...
		{			
			$error="Successfully recorded deposit";
			$obj="";
		}
		else
		{
			$error="could not record deposit";
		}
	}
}
...
?>
 <form action="deposits.php" method="post" class="forms">
            ...
            <?php
              ...
              <tr>
                <td><div align="right"><strong>Amount Deposited:</strong></div></td>
                <td><input name="amount" type="text" id="amount" value="<?php echo $obj->amount; ?>" /></td>
              </tr>
              
              <tr>
                <td><div align="right"><strong>Bank Charges:</strong></div></td>
                <td><input name="bankcharges" type="text" id="bankcharges" value="<?php echo $obj->bankcharges; ?>" /></td>
              </tr>
            ...
            <?php
              ...
              <tr>
                <td><div align="right"><strong>Date Deposited</strong></div></td>
              ...
              <tr>
                <td><div align="right"><strong>Deposit Slip No:</strong></div></td>
              ...
              <tr>
                <td colspan="2"><div align="center">
                  <input type="submit" name="action" id="action" value="Deposit" />
                </div></td>
                </tr>
                <tr>
                <th colspan="2">&nbsp;</th>
