<title>WiseDigits: Imprestaccountemployees </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addimprestaccountemployees_proc.php" name="imprestaccountemployees" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Imprest Account : </td>
...
<?php
	...
	<tr>
		...
		<td><input type="text" name="addedon" id="addedon" class="date_input" size="12" readonly  value="<?php echo $obj->addedon; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
