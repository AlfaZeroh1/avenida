...
<?php } ?>
	...
	<?php
		$i=0;
		$fields="fn_customerpayments.id, fn_customerpayments.patientid, fn_customerpayments.documentno, fn_customerpayments.paidon, fn_customerpayments.amount, sys_paymentmodes.name as paymentmodeid, fn_banks.name as bankid, fn_customerpayments.chequeno, fn_customerpayments.ipaddress, fn_customerpayments.createdby, fn_customerpayments.createdon, fn_customerpayments.lasteditedby, fn_customerpayments.lasteditedon";
