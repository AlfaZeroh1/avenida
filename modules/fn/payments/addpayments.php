<title>WiseDigits ERP: Payments </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addpayments_proc.php" name="payments" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Other Payment : </td>
