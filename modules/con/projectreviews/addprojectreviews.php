<title>WiseDigits: Projectreviews </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addprojectreviews_proc.php" name="projectreviews" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Employee That Reviviewed : </td>
...
<?php
	...
	<tr>
		...
		<td><input type="text" name="reviewedon" id="reviewedon" class="date_input" size="12" readonly  value="<?php echo $obj->reviewedon; ?>"></td>
	</tr>
	<tr>
