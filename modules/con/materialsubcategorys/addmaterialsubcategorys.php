<title>WiseDigits: Materialsubcategorys </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addmaterialsubcategorys_proc.php" name="materialsubcategorys" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Material's Sub-Category : </td>
