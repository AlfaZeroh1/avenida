<title>WiseDigits: Projectusage </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addprojectusage_proc.php" name="projectusage" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Used On : </td>
		<td><input type="text" name="usedon" id="usedon" class="date_input" size="12" readonly  value="<?php echo $obj->usedon; ?>"></td>
	</tr>
	<tr>
