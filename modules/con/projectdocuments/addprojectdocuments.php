<title>WiseDigits: Projectdocuments </title>
<?php 
$pop=1;
include "../../../head.php";
...
<?php
	...
	<tr>
		...
		<td><input type="text" name="documentdate" id="documentdate" class="date_input" size="12" readonly  value="<?php echo $obj->documentdate; ?>"></td>
	</tr>
	<tr>
