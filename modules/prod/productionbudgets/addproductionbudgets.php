<title>WiseDigits ERP: Productionbudgets </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addproductionbudgets_proc.php" name="productionbudgets" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right"> </td>
			<td><input type="hidden" name="greenhousevarietyid" value="<?php echo $obj->greenhousevarietyid; ?>"></td>
	</tr>
	<tr>
  ...
  ?>
	...
	<tr>
		<td align="right">Date Of Budget : </td>
		<td><input type="text" name="budgetedon" id="budgetedon" class="date_input" size="12" readonly  value="<?php echo $obj->budgetedon; ?>"></td>
	</tr>
	<tr>
