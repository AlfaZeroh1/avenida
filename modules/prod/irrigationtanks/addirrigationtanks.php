<title>WiseDigits ERP: Irrigationtanks </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addirrigationtanks_proc.php" name="irrigationtanks" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Irrigation Tank : </td>
