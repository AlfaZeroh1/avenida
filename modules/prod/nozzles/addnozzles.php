<title>WiseDigits ERP: Nozzles </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addnozzles_proc.php" name="nozzles" method="POST" enctype="multipart/form-data">
