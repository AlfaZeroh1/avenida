<title>WiseDigits ERP: Greenhouses </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addgreenhouses_proc.php" name="greenhouses" method="POST" enctype="multipart/form-data">
...
<?php
	...
	$where="  ";
	$fields="prod_sections.id, concat(prod_blocks.name,' ',prod_sections.name) name, prod_sections.blockid, prod_sections.employeeid, prod_sections.remarks, prod_sections.ipaddress, prod_sections.createdby, prod_sections.createdon, prod_sections.lasteditedby, prod_sections.lasteditedon";
