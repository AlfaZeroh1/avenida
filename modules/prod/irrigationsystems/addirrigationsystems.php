<title>WiseDigits ERP: Irrigationsystems </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addirrigationsystems_proc.php" name="irrigationsystems" method="POST" enctype="multipart/form-data">
