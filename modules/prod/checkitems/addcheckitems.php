<title>WiseDigits ERP: Checkitems </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addcheckitems_proc.php" name="checkitems" method="POST" enctype="multipart/form-data">
