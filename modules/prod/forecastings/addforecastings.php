<title>WiseDigits ERP: Forecastings </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addforecastings_proc.php" name="forecastings" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Forecast Week : </td>
        ...
        ?>
      </select>&nbsp;<select name="year" id="year" class="selectbox">
          <option value="">Select...</option>
          <?php
  $i=date("Y")-10;
  while($i<date("Y")+10)
