...
if(existsRule($auth)){
?>
<div style="float:left;" class="buttons"> <input class="btn btn-info" onclick="showPopWin('addmixturefertilizers_proc.php?mixtureid=<?php echo $ob->mixtureid; ?>',600,430);" value="Add Mixturefertilizers " type="button"/></div>
<?php }?>
...
<?php } ?>
	...
	<?php
		...
		if(!empty($ob->mixtureid))
		  $where=" where prod_mixturefertilizers.mixtureid='$ob->mixtureid' ";
		$mixturefertilizers->retrieve($fields,$join,$where,$having,$groupby,$orderby);echo mysql_error();
