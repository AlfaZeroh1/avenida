<title>WiseDigits ERP: Blocks </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addblocks_proc.php" name="blocks" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" name="length" id="length" size="8"  value="<?php echo $obj->length; ?>"></td>
	</tr>
	<tr>
		<td align="right">Width : </td>
		<td><input type="text" name="width" id="width" size="8"  value="<?php echo $obj->width; ?>"></td>
	</tr>
	<tr>
