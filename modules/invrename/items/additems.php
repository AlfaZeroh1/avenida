...
<?php
	...
	<tr>
		...
		<td><input value="simpel" name="type" type="radio">Simple <input value="complex" name="type" type="radio">Complex</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><select name='type' class="selectbox">
			<option value='simple' <?php if($obj->type=='simple'){echo"checked";}?>>simple</option>
			<option value='complex' <?php if($obj->type=='complex'){echo"checked";}?>>complex</option>
		</select></td>
	</tr>
	
	<tr>
		<td align="right">Sell Cold/Warm : </td>
		<td>
			<input type="radio" name="warmth" id="warmth" value='1' <?php if($obj->warmth=='1'){echo"checked";}?>>Yes</option>
			<input type="radio" name="warmth" id="warmth" value='0' <?php if($obj->warmth=='0'){echo"checked";}?>>No</option>
		</select></td>
	</tr>
