<title>WiseDigits ERP: Customerseasons </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addcustomerseasons_proc.php" name="customerseasons" method="POST" enctype="multipart/form-data">
