<title>WiseDigits ERP: Customerissues </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addcustomerissues_proc.php" name="customerissues" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" name="customerid" id="customerid" value="<?php echo $obj->customerid; ?>"></td>
	</tr>
	<tr>
		<td align="right">Issue Type : </td>
		<td><input type="text" name="issuetypeid" id="issuetypeid" value="<?php echo $obj->issuetypeid; ?>"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><select name='status' class="selectbox">
			...
			<option value='In-progress' <?php if($obj->status=='In-progress'){echo"selected";}?>>In-progress</option>
			<option value='finished' <?php if($obj->status=='finished'){echo"selected";}?>>finished</option>
		</select></td>
	</tr>
	<tr>
...
<?php
	...
	<tr>
		<td align="right">Started On : </td>
		<td><input type="text" name="startedon" id="startedon" class="date_input" size="12" readonly  value="<?php echo $obj->startedon; ?>"></td>
	</tr>
	<tr>
		<td align="right">Finished On : </td>
		<td><input type="text" name="finishedon" id="finishedon" class="date_input" size="12" readonly  value="<?php echo $obj->finishedon; ?>"></td>
	</tr>
	<tr>
