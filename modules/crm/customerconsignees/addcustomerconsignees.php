<title>WiseDigits ERP: Customerconsignees </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addcustomerconsignees_proc.php" name="customerconsignees" method="POST" enctype="multipart/form-data">
