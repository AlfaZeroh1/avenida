<title>WiseDigits ERP: Potentialcustomervisits </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addpotentialcustomervisits_proc.php" name="potentialcustomervisits" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Customer : </td>
			<td><select name="potentialcustomerid" class="selectbox">
...
<?php
	...
	?>
		<option value="<?php echo $rw->id; ?>" <?php if($obj->potentialcustomerid==$rw->id){echo "selected";}?>><?php echo initialCap($rw->name);?></option>
	<?php
	}
	?>
