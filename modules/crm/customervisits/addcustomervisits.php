<title>WiseDigits ERP: Customervisits </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addcustomervisits_proc.php" name="customervisits" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Visted On : </td>
		<td><input type="text" name="vistedon" id="vistedon" class="date_input" size="12" readonly  value="<?php echo $obj->vistedon; ?>"></td>
	</tr>
	<tr>
		<td align="right">Visited By : </td>
