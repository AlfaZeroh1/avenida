...
//Authorization.
$auth->roleid="4798";//View
$auth->levelid=$_SESSION['level'];

if(existsRule($auth)){
?>
<div style="float:left;" class="buttons"> <input class="btn btn-info" onclick="showPopWin('addstatuss_proc.php',600,430);" value="Add Statuss " type="button"/></div>
<?php }?>
