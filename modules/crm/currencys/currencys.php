...
//Authorization.
$auth->roleid="8833";//View
$auth->levelid=$_SESSION['level'];

if(existsRule($auth)){
?>
<div style="float:left;" class="buttons"> <input class="btn btn-info" onclick="showPopWin('addcurrencys_proc.php',600,430);" value="Add Currencys " type="button"/></div>
<?php }?>
