...
if(!empty($id)){
	...
	$fields="inv_compositeitems.id, inv_items.name itemname, inv_items2.name itemname2, inv_compositeitems.itemid, inv_compositeitems.itemid2, inv_compositeitems.itemid2, inv_compositeitems.quantity, inv_compositeitems.remarks, inv_compositeitems.ipaddress, inv_compositeitems.createdby, inv_compositeitems.createdon, inv_compositeitems.lasteditedby, inv_compositeitems.lasteditedon, inv_compositeitems.reducing ";
	$join=" left join inv_items on inv_items.id=inv_compositeitems.itemid left join inv_items inv_items2 on inv_items2.id=inv_compositeitems.itemid2 ";
	$having="";
	$groupby="";
	$orderby="";
