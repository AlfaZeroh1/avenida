...
class RequisitionsDBO extends DB{
 ...
 var $table="proc_requisitions";
	...
	function update($obj,$where=""){			
		...
		$sql="update proc_requisitions set documentno='$obj->documentno',description='$obj->description',departmentid=$obj->departmentid,projectid=$obj->projectid,requisitiondate='$obj->requisitiondate',remarks='$obj->remarks',status='0',file='$obj->file',ipaddress='$obj->ipaddress',lasteditedby='$obj->lasteditedby',lasteditedon='$obj->lasteditedon',employeeid='$obj->employeeid' where $where ";
		$this->sql=$sql;
		if(mysql_query($sql,$this->connection)){		
			return true;	
		}
