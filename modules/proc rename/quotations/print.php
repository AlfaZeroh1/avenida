  ...
  <thead>
	...
	?>
	  ...
	  <td align="right" style="border-bottom: 1px solid black; border-top: 1px solid black;"><strong><div align="right"><?php echo formatNumber($total);?></div></strong></td>
       ...
       <table width="100%" style="font-size:10px;">
       <tr height="30" style="font-weight:bold;border-bottom: 0px; border-top: 0px;">
  <td style="font-weight:bold;border-bottom: 0px; border-top: 0px;">Prepared  By: <?php echo $orders->employeeid; ?>________________________ </td><td style="font-weight:bold;border-bottom: 0px; border-top: 0px;"> Date: ________________________</td>
  </tr>
