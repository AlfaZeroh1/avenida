<title>WiseDigits ERP: Employeecalendar </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addemployeecalendar_proc.php" name="employeecalendar" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		...
		<td><input type="text" name="eventname" id="eventname" size="45"  value="<?php echo $obj->eventname; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
