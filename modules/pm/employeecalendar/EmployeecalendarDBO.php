...
class EmployeecalendarDBO extends DB{
 ...
 var $table="pm_employeecalendar";
	...
	function persist($obj){
		$sql="insert into pm_employeecalendar(id,employeeid,startdate,starttime,enddate,endtime,eventname,taskid,location,description,remarks,ipaddress,createdby,createdon,lasteditedby,lasteditedon)
						values('$obj->id',$obj->employeeid,'$obj->startdate','$obj->starttime','$obj->enddate','$obj->endtime','$obj->eventname','$obj->taskid','$obj->location','$obj->description','$obj->remarks','$obj->ipaddress','$obj->createdby','$obj->createdon','$obj->lasteditedby','$obj->lasteditedon')";		
		$this->sql=$sql;
