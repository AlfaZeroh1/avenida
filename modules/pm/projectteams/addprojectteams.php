<title>WiseDigits ERP: Projectteams </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addprojectteams_proc.php" name="projectteams" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Team Position : </td>
			<td><select name="teampositionid" class="selectbox">
<option value="">Select...</option>
<?php
