...
<script type="text/javascript" charset="utf-8">
 ...
 <div align="center">
  <a href="?status=unread">Inbox</a>| <a href="?status=read">Read</a>| 
 </div>
<table id="example">
	<thead>
		<tr>
...
<?php } ?>
	...
	<?php
		...
		if(!empty($ob->status))
		  $where.=" and pm_notificationrecipients.status='$ob->status' ";
	...
	?>
		<tr style="color:<?php if($row->status=='unread'){echo '#F00';}?>">
			<td><?php echo $i; ?></td>
			<td><a data-toggle="modal" data-target="#popUp" href='../notifications/addnotifications_proc.php?id=<?php echo $row->notificationid; ?>&notificationrecipientid=<?php echo $row->id; ?>&status=<?php echo $row->status; ?>&not=true',900,480);"><?php echo $row->subject; ?></a></td>
