...
<ul id="cmd-buttons" style="list-style-type:none;">
	...
	<li><a class="button icon chat" href="../../pm/teampositions/teampositions.php">Team Positions</a></li>	
	<li><a class="button icon chat" href="../../pm/projects/projects.php">Projects</a></li>
	<li><a class="button icon chat" href="gantt.php">Gantt Chart</a></li>
</ul>
<?php
include"../../../foot.php";
?>
