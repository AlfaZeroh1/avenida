<title>WiseDigits: Billofquantities </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addbillofquantities_proc.php" name="billofquantities" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		...
		<td><textarea name="bqitem"><?php echo $obj->bqitem; ?></textarea><font color='red'>*</font></td>
	</tr>
	<tr>
