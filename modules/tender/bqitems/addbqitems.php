<title>WiseDigits: Bqitems </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addbqitems_proc.php" name="bqitems" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Actual Rate : </td>
		<td><input type="text" name="actualrate" id="actualrate" size="8"  value="<?php echo $obj->actualrate; ?>"></td>
	</tr>
	<tr>
