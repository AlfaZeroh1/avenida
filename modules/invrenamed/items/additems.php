...
?>
 ...
 function calculateValue(){
	...
	var xmlhttp;
	var url="setValue.php?costprice="+costprice+"&currencyid="+currencyid;
	...
	xmlhttp.onreadystatechange=function() {
		if (xmlhttp.readyState==4)
		{
			...
			nvalue=Math.round(data*Math.pow(10,2))/Math.pow(10,2);
			$("#value").val(nvalue);
		}
	};
...
<form  id="theform" action="additems_proc.php" name="items" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" size="40" name="name" id="name" value="<?php echo $obj->name; ?>"><font color='red'>*</font></td>
	</tr>
	<!--<tr>
	...
	<!--<tr>
	  ...
	  <td><select name="currencyid" id="currencyid" onchange="calculateValue();">
	...
	<tr>
		...
		<td><input type="text" size="40" name="itemname" id="itemname" value="<?php echo $obj->itemname; ?>"/>
		    <input type="hidden" name="itemid" id="itemid" value="<?php echo $obj->itemid; ?>"/>
...
<?php
	...
	<tr>
		...
		<td><input type="text" name="costprice" id="costprice" size="8"  value="<?php echo $obj->costprice; ?>" onchange="calculateValue();"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="value" id="value" size="8" readonly  value="<?php echo $obj->value; ?>"></td>
	</tr>
	<tr>
...
<?php
	...
	<tr>
		...
		<td><select name="type" class="selectbox">
			<option value="simple" <?php if($obj->type=="simple"){echo"selected";}?>>Simple</option>
			<option value="complex" <?php if($obj->type=="complex"){echo"selected";}?>>Complex</option>
		</select></td>
	</tr>
	<tr>
		<td align="right">Volume : </td>
		<td><input type="text" name="volume" id="volume" size="8"  value="<?php echo $obj->volume; ?>"></td>
	</tr>
	<tr>
		<td align="right">Package : </td>
		<td><input type="text" name="package" id="package" size="8"  value="<?php echo $obj->package; ?>"></td>
	</tr>
	
	
	<tr>
		<td align="right">Sell Condition : </td>
		<td>
			<input type="radio" name="warmth" id="warmth" value='0' <?php if($obj->warmth=='0'){echo"checked";}?>>None</option>
			<input type="radio" name="warmth" id="warmth" value='1' <?php if($obj->warmth=='1'){echo"checked";}?>>Cold/Warm</option>
			<input type="radio" name="warmth" id="warmth" value='2' <?php if($obj->warmth=='2'){echo"checked";}?>>Boiled/Chome/Wet Fry/Dry Fry</option>
		</select></td>
	</tr>
	
	<tr>
		<td align="right">Image : </td>
		<td><textarea name='image'><?php echo $obj->image; ?></textarea></td>
