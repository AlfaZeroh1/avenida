<title>WiseDigits ERP: Unitofmeasures </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addunitofmeasures_proc.php" name="unitofmeasures" method="POST" enctype="multipart/form-data">
