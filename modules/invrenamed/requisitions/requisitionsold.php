...
// 		if($employees->assignmentid==$routes->assignmentid)		
		   $where=" where inv_requisitions.status=2 and inv_requisitions.requisitiondate>'2018-02-15' ";
// 		else 
// 		   $where="  ";
...
?>
			...
			<td><a href="addrequisitions_proc.php?documentno=<?php echo $row->documentno; ?>&retrieve=1&dispatch=1&action=1">Dispatch</a></td>
			<td><a href="addrequisitions_proc.php?documentno=<?php echo $row->documentno; ?>&retrieve=1&dispatch=1&action=1">ISSUE</a></td>
			<td><a href="addrequisitions_proc.php?documentno=<?php echo $row->documentno; ?>&retrieve=1">View</a></td>
<?php
}
//Authorization.
$auth->roleid="7505";//View
