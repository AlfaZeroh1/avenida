<title>WiseDigits: Insurers </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addinsurers_proc.php" name="insurers" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Contact Tel : </td>
		<td><input type="text" name="contacttel" id="contacttel" value="<?php echo $obj->contacttel; ?>"></td>
	</tr>
	<tr>
