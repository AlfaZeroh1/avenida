<title>WiseDigits ERP: Employees </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addemployees_proc.php" name="employees" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		...
		<td><input type="text" name="datefrom" id="datefrom" class="date_input" size="12" readonly  value="<?php echo $obj->datefrom; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><textarea name="reason"><?php echo $obj->reason; ?></textarea><font color='red'>*</font></td>
	</tr>
	<tr>
