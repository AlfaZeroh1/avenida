<title>WiseDigits ERP: Consumables </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addconsumables_proc.php" name="consumables" method="POST" enctype="multipart/form-data">
