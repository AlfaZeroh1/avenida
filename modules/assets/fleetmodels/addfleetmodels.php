<title>WiseDigits: Fleetmodels </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addfleetmodels_proc.php" name="fleetmodels" method="POST" enctype="multipart/form-data">
...
<?php
	...
	while($rw=mysql_fetch_object($fleetmakes->result)){
	?>
		<option value="<?php echo $rw->id; ?>" <?php if($obj->fleetmakeid==$rw->id){echo "selected";}?>><?php echo initialCap($rw->name);?></option>
	<?php
	}
	?>
</select>
