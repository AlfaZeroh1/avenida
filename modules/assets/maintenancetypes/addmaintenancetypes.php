<title>WiseDigits ERP: Maintenancetypes </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addmaintenancetypes_proc.php" name="maintenancetypes" method="POST" enctype="multipart/form-data">
