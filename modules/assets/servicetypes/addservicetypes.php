<title>WiseDigits ERP: Servicetypes </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addservicetypes_proc.php" name="servicetypes" method="POST" enctype="multipart/form-data">
