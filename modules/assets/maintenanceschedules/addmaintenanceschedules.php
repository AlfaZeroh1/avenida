<title>WiseDigits ERP: Maintenanceschedules </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addmaintenanceschedules_proc.php" name="maintenanceschedules" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Next Inspection Date : </td>
		<td><input type="text" name="nextinspection" id="nextinspection" class="date_input" size="12" readonly  value="<?php echo $obj->nextinspection; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
