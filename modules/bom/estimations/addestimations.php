...
<form class="forms" id="theform" action="addestimations_proc.php" name="estimations" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td colspan="2"><input type="text" name="prc" id="prc" value="<?php echo $obj->prc; ?>"></td>
	</tr>
	<tr>
