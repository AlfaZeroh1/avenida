<title>EIMS: Paymentcategorys </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addpaymentcategorys_proc.php" name="paymentcategorys" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td colspan="2" align="center"><input type="submit" name="action" id="action" class="btn btn-info" value="<?php echo $obj->action; ?>">&nbsp;<input type="submit" name="action" id="action" class="btn btn-warning" value="Cancel" onclick="window.top.hidePopWin(true);"/></td>
	</tr>
<?php if(!empty($obj->id)){?>
<?php }?>
	<?php if(!empty($obj->id)){?> 
