...
require_once("../../sys/notificationtypes/Notificationtypes_class.php");
require_once("../../hrm/employees/Employees_class.php");
//Authorization.
if(!empty($_GET['id'])){
	$auth->roleid="7765";//Edit
}
else{
	$auth->roleid="7763";//Add
}
