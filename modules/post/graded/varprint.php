...
<script type="text/javascript">
   function print_doc()
  {
		...
		jsPrintSetup.setOption('marginTop','8');
...
$str=str_pad($obj->varietyid,13,0,STR_PAD_LEFT);
...
<img
src="../../barcodes/php.php?bctext=<?php echo $str; ?>&text=<?php echo $obj->desc; ?>" height="30px" width="160px"
