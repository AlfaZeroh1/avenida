...
<script type="text/javascript">
   function print_doc()
  {
		...
		jsPrintSetup.setOption('marginTop','13');
...
td{padding-left:18px !important;margin:0px !important;}
...
$str=str_pad($obj->employeeid,26,0,STR_PAD_LEFT);
?>
  
  <?php if($i%4==0){ ?>
  <tr>
  <?php }?>
  <td style="padding-left:5px;padding-top:8px;padding-right:5px;padding-bottom:5px;">
<img
src="../../barcodes/php.php?bctext=<?php echo $str; ?>&text=<?php echo $obj->desc; ?>" height="34px" width="170px"
