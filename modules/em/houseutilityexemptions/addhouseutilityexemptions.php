<title>WiseDigits: Houseutilityexemptions </title>
<?php 
$pop=1;
include "../../../head.php";
...
<form class="forms" action="addhouseutilityexemptions_proc.php" name="houseutilityexemptions" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Utility : </td>
			<td><select class="selectbox" name="utilityid">
<option value="">Select...</option>
<?php
	...
	while($rw=mysql_fetch_object($utilitys->result)){
	?>
