...
<td colspan="7">
    ...
    $fields="em_landlordreceipts.id,concat(concat(em_landlords.firstname,' ',em_landlords.middlename), ' ', em_landlords.lastname) landlordid, em_landlordreceipts.documentno,  em_plots.name as plotid, em_paymentterms.name as paymenttermid, sys_paymentmodes.name as paymentmodeid, fn_banks.name as bankid, em_landlordreceipts.chequeno, em_landlordreceipts.amount, em_landlordreceipts.paidon, em_landlordreceipts.month, em_landlordreceipts.year, em_landlordreceipts.receivedby, em_landlordreceipts.remarks";
	...
	$groupby="";
	$orderby="";
	$where=" where em_landlordreceipts.documentno='$doc' ";
