...
$landlord = $_GET['landlordid'];
$doc=$_GET['doc'];
$invoicedon=$_GET['paidon'];

$landlord = new Landlords();
$fields = "*";
$where=" where id='$landlord' ";
$join="";
$having="";
$groupby="";
$orderby="";
$landlord->retrieve($fields, $join, $where, $having, $groupby, $orderby);
$landlord=$landlord->fetchObject;
...
<div id="testTable2">
          <table id="menuTable2">
            ...
            <div id="company">           
            <h2><?php echo $landlord->firstname; ?> <?php echo $landlord->lastname; ?> </h2>
            <span class="desc">Status<?php echo $landlord->status; ?></span>
            <span class="addr"><?php echo $landlord->address; ?>,<br/></span>
            <span class="tel">Tel: <?php echo $landlord->mobile; ?></span>  
            <strong>
           ...
           <td colspan="3">
            ...
            <span class="name"><?php echo $tenants->firstname; ?>&nbsp;<?php echo $tenants->middlename; ?>&nbsp;<?php echo $tenants->lastname; ?></span>
              ...
              <tr>
                  <th width="170" ><span style="text-decoration:underline;">Plot</span></th>
			      <th width="170" ><span style="text-decoration:underline;">Hse No</span></th>
			      <th width="43" class="stitle"><span style="text-decoration:underline;">Desc</span></th>
			      <th width="76" align="center"><span style="text-decoration:underline;">Month</span></th>
			      <th width="81" align="center"><span style="text-decoration:underline;">Amount</span></th>
			      <th width="35" align="center"><span style="text-decoration:underline;">VAT</span></th>
			      <th width="41" align="left"><span style="text-decoration:underline;">Total</span></th>
      		</tr>
    ...
    $fields="em_landlordpayments.id, em_landlordpayments.documentno, em_paymentterms.name as paymenttermid, em_landlordpayments.vatamount, em_plots.name, em_landlordpayments.month, em_landlordpayments.year, em_landlordpayments.invoicedon, em_landlordpayments.quantity, em_landlordpayments.amount, em_landlordpayments.remarks";
	$join="left join em_plots on em_plots.id=em_landlordpayments.plotid";
	$having="";
	$groupby="";
	$orderby="";
	$where=" where em_landlordpayments.documentno='$doc' ";
	$landlordpayments->retrieve($fields,$join,$where,$having,$groupby,$orderby);echo mysql_error();
