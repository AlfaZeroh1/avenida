<title>WiseDigits: Houserents </title>
<?php 
$pop=1;
include "../../../head.php";
...
<form class="forms" action="addhouserents_proc.php" name="houserents" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Previous Rent : </td>
		<td><input type="text" name="previous" id="previous" size="8"  value="<?php echo $obj->previous; ?>"></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="right">Current Rent : </td>
		<td><input type="text" name="current" id="current" size="8"  value="<?php echo $obj->current; ?>"></td>
	</tr>
	<tr>
