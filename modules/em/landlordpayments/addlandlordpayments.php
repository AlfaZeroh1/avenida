...
function loadPaymentModes(str)
{
	...
	if(str.value==null || str.value==1)
	{
		...
		///name=""
// 		document.getElementById("landlordid").value=data[1];
// 		document.getElementById("registeredon").value=data[8];
// 		document.getElementById("postaladdress").value=data[13];
		text.innerHTML="show";
	}
...
<form action="addlandlordpayments_proc.php" name="landlordpayments" class="forms" method="POST" enctype="multipart/form-data">
...
<table class="table display" width="100%">
	...
	if($_SESSION['shplandlordpayments']){
		...
		<tr style="font-size:12px; vertical-align:text-top; ">
			...
			<td><a href='edit.php?i=<?php echo $i; ?>&action=edit&edit=<?php echo $obj->edit; ?>&obj=<?php  echo $ob; ?>&url=addlandlordpayments_proc.php'>Edit</a></td>
			<td><a href='edit.php?i=<?php echo $i; ?>&action=del&edit=<?php echo $obj->edit; ?>&obj=<?php  echo $ob; ?>&url=addlandlordpayments_proc.php'>Del</a></td>
		</tr>
		<?php
		$i++;
		$j--;
...
if($saved=="Yes")
{
    ...
    //redirect("addlandlordpayments_proc.php");
  }
