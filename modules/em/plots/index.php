...
<ul id="cmd-buttons">
	...
	<li><a class="button icon chat" href="../../fn/exptransactions/exptransactions.php">Payment Vouchers</a></li>
	<li><a class="button icon chat" href="../../fn/exptransactions/exptransactions.php?retrieve=1">Retrieve Payment Vouchers</a></li>
