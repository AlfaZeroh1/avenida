<title>WiseDigits: Housespecialdepositexemptions </title>
<?php 
$pop=1;
include "../../../head.php";
...
<form class="forms" action="addhousespecialdepositexemptions_proc.php" name="housespecialdepositexemptions" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Special Deposit : </td>
			<td><select class="selectbox" name="paymenttermid">
<option value="">Select...</option>
<?php
