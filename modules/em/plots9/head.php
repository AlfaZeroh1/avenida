...
<link rel="stylesheet" href="../../../../fs-css/cont.css" media="all">
<link rel="stylesheet" href="../../../../fs-css/base/jquery.ui.all.css">
<link rel="stylesheet" href="../../../../fs-css/demos.css" media="all">
...
<div id="uselog">
     ...
     <a href="javascript:;" onclick="showPopWin('../../../../administration/edituser.php?id=<?php echo $_SESSION['userid'];?>',400,350);" >edit</a>&nbsp;<a href="../../auth/users/logout.php" style="">Log Out</a>&nbsp;</div>
		 <? 
         }
         ?>
   <div id="formbox">
<div id="baz"><span>User Switch</span><a href="javascript:;" id="slick-hide"><img id="hideImg" src="../../../../j-modal/close2.gif" align="right" /></a>
<div style="clear:both;"></div>
</div>
<form action="../../../../modules/administration/login.php?url=<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="login" id="login">
<fieldset>
<label>Username:</label><input name="username" type="text" value="<?php echo $obj->username; ?>" size="18" />
</fieldset>
<fieldset>
<label>Password:</label><input name="password" type="password" size="18" />
</fieldset>
<fieldset>
<input style=" margin-left:40%; padding:2px;" name="action" type="submit" value="Login" />
</fieldset>
</form>
</div>
</div>
...
<div class="navigation"><a href="javascript:;" onmouseover="showmenu('navamenu')" onmouseout="timeOut('navamenu')">NAV</a>
      <div id="navamenu">
     <ul class="navul">
     <?php	 
