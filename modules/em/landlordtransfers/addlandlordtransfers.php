...
<form action="addlandlordtransfers_proc.php" name="landlordpayments" class="forms" method="POST" enctype="multipart/form-data">
...
<table class="table display" width="100%">
	...
	if($_SESSION['shplandlordreceipts']){
		$shplandlordtransfers=$_SESSION['shplandlordreceipts'];
		$i=0;
		$j=$obj->iterator;
		$total=0;
		while($j>0){

		$total+=$shplandlordtransfers[$i]['amount'];
		?>
		<tr style="font-size:12px; vertical-align:text-top; ">
			<td><?php echo ($i+1); ?></td>
			<td><?php echo $shplandlordtransfers[$i]['plotname']; ?> </td>
			<td><?php echo $shplandlordtransfers[$i]['paymenttermname']; ?> </td>
			<td align="right"><?php echo formatNumber($shplandlordtransfers[$i]['amount']); ?> </td>
			<td><?php echo getMonth($shplandlordtransfers[$i]['month']); ?> </td>
			<td><?php echo $shplandlordtransfers[$i]['year']; ?> </td>
			<td><?php echo $shplandlordtransfers[$i]['remarks']; ?> </td>
