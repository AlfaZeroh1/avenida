<title>WiseDigits: Housetenants </title>
<?php 
$pop=1;
include "../../../head.php";
...
$().ready(function() {
  $("#tenantname").autocomplete({
	source:"../../../modules/server/server/search.php?main=em&module=tenants&field=name",
...
<form action="addhousetenants_proc.php" name="housetenants" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Last Month Invoiced : </td>
		<td><input type="text" name="lastmonthinvoiced" id="lastmonthinvoiced" value="<?php echo $obj->lastmonthinvoiced; ?>"></td>
	</tr>
	<tr>
		<td align="right">Last Year Invoiced : </td>
		<td><input type="text" name="lastyearinvoiced" id="lastyearinvoiced" value="<?php echo $obj->lastyearinvoiced; ?>"></td>
	</tr>
	<tr>
