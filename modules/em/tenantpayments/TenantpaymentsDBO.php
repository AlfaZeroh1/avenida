...
class TenantpaymentsDBO extends DB{
 ...
 var $table="em_tenantpayments";
	...
	function persist($obj,$bool){
		$sql="insert into em_tenantpayments(id,tenantid,houseid,documentno,paymenttermid,paymentmodeid,bankid,chequeno,commission,commissiontype,amount,paidon,month,year,paidby,remarks,ipaddress,createdby,createdon,lasteditedby,lasteditedon)
						values('$obj->id','$obj->tenantid','$obj->houseid','$obj->documentno','$obj->paymenttermid','$obj->paymentmodeid','$obj->bankid','$obj->chequeno','$obj->commission','$obj->commissiontype','$obj->amount','$obj->paidon','$obj->month','$obj->year','$obj->paidby','$obj->remarks','$obj->ipaddress','$obj->createdby','$obj->createdon','$obj->lasteditedby','$obj->lasteditedon')";		
		$this->sql=$sql;
		if($bool){
