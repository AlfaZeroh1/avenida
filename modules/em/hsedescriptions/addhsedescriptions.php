<title>WiseDigits: Hsedescriptions </title>
<?php 
$pop=1;
include "../../../head.php";
...
<form class="forms" action="addhsedescriptions_proc.php" name="hsedescriptions" method="POST" enctype="multipart/form-data">
