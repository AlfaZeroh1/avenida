...
function loadPaymentModes(str)
{
	...
	var landlord = document.getElementById("landlorddiv");
...
<?php
  ...
  ?>
	...
	<td><input type="submit" class="btn" name="action2" value="Add"/></td>
		...
		<div id="landlorddiv">
		<input type='text' size='20' name='plotname' id='plotname' value='<?php echo $obj->plotname; ?>'>
					<input type="hidden" name='plotid' id='plotid' value='<?php echo $obj->plotid; ?>'>
		</div>
