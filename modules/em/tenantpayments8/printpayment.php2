...
<table width="100%">
    ...
    <tr class="<?php echo $some_class; ?>">
	  ...
	  ?>
       ...
       <strong>Total</strong>:<strong> <?php echo formatNumber($total); ?></strong>
       </td>
       </tr>          
 </table>
</td>
...
<tr>
<td colspan="10">
For <?php echo $_SESSION['companyname']; ?><br />
<br />
<br />
&nbsp;
SIGN:
...
<p style="font-family:'tahoma';font-size:12px;">Paid By: <?php echo initialCap($tn->paidby); ?></p>
<p style="font-family:'tahoma';font-size:12px;">Served By: <?php echo $_SESSION['username']; ?></p>
<p style="font-family:'tahoma';font-size:12px;">Note: Refunds of any kind shall attract levy</p>
</td>
</tr>
