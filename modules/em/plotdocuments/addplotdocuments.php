<title>WiseDigits: Plotdocuments </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addplotdocuments_proc.php" name="plotdocuments" method="POST" enctype="multipart/form-data">
