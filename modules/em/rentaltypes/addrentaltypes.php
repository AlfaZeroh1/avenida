<title>WiseDigits: Rentaltypes </title>
<?php 
$pop=1;
include "../../../head.php";
...
<form class="forms" action="addrentaltypes_proc.php" name="rentaltypes" method="POST" enctype="multipart/form-data">
	...
	<tr>
		<td align="right">Payable After (Months) : </td>
		<td><input type="text" name="months" id="months" value="<?php echo $obj->months; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
