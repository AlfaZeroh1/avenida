<title>WiseDigits: Housespecialdeposits </title>
<?php 
$pop=1;
include "../../../head.php";
...
<form class="forms" action="addhousespecialdeposits_proc.php" name="housespecialdeposits" method="POST" enctype="multipart/form-data">
