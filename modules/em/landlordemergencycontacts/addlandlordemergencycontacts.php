<title>WiseDigits: Landlordemergencycontacts </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addlandlordemergencycontacts_proc.php" name="landlordemergencycontacts" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		...
		<td><input type="text" name="relation" id="relation" value="<?php echo $obj->relation; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
