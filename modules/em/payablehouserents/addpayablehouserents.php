<title>WiseDigits: Payablehouserents </title>
<?php 
$pop=1;
include "../../../head.php";
...
<form class="forms" action="addpayablehouserents_proc.php" name="payablehouserents" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Invoiced On : </td>
		<td><input type="text" name="invoicedon" id="invoicedon" class="date_input" size="12" readonly  value="<?php echo $obj->invoicedon; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
