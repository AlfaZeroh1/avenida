...
<img src="php.php?num=<?php echo($num) ?>&type=int25&imgtype=png"
...
<h2>Ean13 (png):</h2>
<img
src="php.php?num=<?php echo($num) ?>&type=ean13&imgtype=png"
alt="PNG: <?php echo($num) ?>" title="PNG: <?php echo($num) ?>">
</div>
...
<h2>Code39 (png):</h2>
<img
src="php.php?num=<?php echo($num) ?>&type=Code39&imgtype=png"
alt="PNG: <?php echo($num) ?>" title="PNG: <?php echo($num) ?>">
</div>
...
<h2>UPC-A (png):</h2>
<img
src="php.php?num=<?php echo($num) ?>&type=upca&imgtype=png"
alt="PNG: <?php echo($num) ?>" title="PNG: <?php echo($num) ?>">
</div>
...
<h2>Code128 (png):</h2>
<img
src="php.php?num=<?php echo($num) ?>&type=code128&imgtype=png"
alt="PNG: <?php echo($num) ?>" title="PNG: <?php echo($num) ?>">
</div>
...
<h2>PostNet (png):</h2>
<img
src="php.php?num=<?php echo($num) ?>&type=postnet&imgtype=png"
alt="PNG: <?php echo($num) ?>" title="PNG: <?php echo($num) ?>">
</div>
