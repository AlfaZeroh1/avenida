...
?>
  ...
  <?php if($obj->type==1){ ?>
  <div class="tag">
    <a href="javascript:;" class="btns waves-effect" <?php if(empty($rw->warmth)){?> onClick="saveForm('<?php echo $rw->id; ?>','1','');" <?php }else{ ?> onclick="loadWarmthModal('<?php echo $rw->id; ?>','1');" <?php } ?>>
