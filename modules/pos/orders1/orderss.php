...
// 		}
		...
		if($_SESSION['levelid']!=1 and $_SESSION['levelid']!=5 and $_SESSION['levelid']!=9){
...
// 		  $where.=" and pos_orders.status=1 ";
	...
	?>
		<tr style="color:<?php echo $color; ?>">
			...
			<td><a onclick="showPopWin('orders.php?tableno=<?php echo $row->tableno; ?>&pop=1&orderedon=<?php echo $obj->orderedon; ?>&orderno=<?php echo $row->orderno; ?>&orderid=<?php echo $row->id; ?>&createdby=<?php echo $row->createdby; ?>&employeeid=<?php echo $row->employeeid; ?>',700,630);" href="javascript:;"><?php echo strtoupper($row->tableno); ?></a></td>
