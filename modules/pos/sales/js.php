...
try{
  ...
  <?php
  if($obj->mode=='cashretail' or $obj->mode=='creditretail')
  {
  ?>
	  var retail=parseFloat(document.getElementById("retailprice").value);
  <?php
  }
  else
  {
  ?>
	  var retail=parseFloat(document.getElementById("tradeprice").value);
  <?php
  }
  ?>    
