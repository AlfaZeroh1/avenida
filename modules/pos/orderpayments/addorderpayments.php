...
<form class="forms" id="theform" action="addorderpayments_proc.php" name="orderpayments" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" readonly name="orderid" id="orderid" value="<?php echo $obj->orderid; ?>">
		    <input type="hidden" readonly name="billno" id="billno" value="<?php echo $obj->billno; ?>"></td>
	</tr>
	<tr>
