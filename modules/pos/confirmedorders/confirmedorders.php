...
?>
	...
	?>
		<tr>
			...
			<td><a href='../packinglists/addpackinglists_proc.php?packingno=<?php echo $packinglists->documentno; ?>&customerid=<?php echo $row->customer; ?>&boxno=<?php echo $packinglists->boxes+1; ?>'><?php echo $packinglists->documentno; ?></a></td>
...
//   if($packinglists->boxes!=$confirmedorderdetails->quantity){
  ?>
			<td><a href='../packinglists/addpackinglists_proc.php?orderno=<? echo $row->orderno; ?>&boxing=1&packingno=<?php echo $packinglists->documentno; ?>&boxno=<?php echo $packinglists->boxes+1; ?>&customerid=<?php echo $row->customer; ?>'>Box:<?php echo $packinglists->boxes+1; ?></a></td>
