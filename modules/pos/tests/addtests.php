...
<form class="forms" id="theform" action="addtests_proc.php" name="tests" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right"> : </td>
		<td><input type="text" name="ipaddres" id="ipaddres" value="<?php echo $obj->ipaddres; ?>"></td>
	</tr>
	<tr>
