<title>WiseDigits ERP: Orderdetails </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addorderdetails_proc.php" name="orderdetails" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Order : </td>
			<td><select name="orderid" class="selectbox">
<option value="">Select...</option>
<?php
	$orders=new Orders();
	$where="  ";
	...
	?>
		<option value="<?php echo $rw->id; ?>" <?php if($obj->orderid==$rw->id){echo "selected";}?>><?php echo initialCap($rw->name);?></option>
	<?php
	}
	?>
</select><font color='red'>*</font>
