...
//Authorization.
if(!empty($_GET['id'])){
	$auth->roleid="7508";//Edit
}
else{
	$auth->roleid="7506";//Add
}
...
if(!empty($id)){
	$deliverynotes=new Deliverynotes();
	$where=" where id=$id ";
	$fields="pos_deliverynotes.id, pos_deliverynotes.documentno, pos_deliverynotes.lpono, pos_deliverynotes.customerid, pos_deliverynotes.deliveredon, pos_deliverynotes.itemid, pos_deliverynotes.quantity, pos_deliverynotes.remarks, pos_deliverynotes.ipaddress, pos_deliverynotes.createdby, pos_deliverynotes.createdon, pos_deliverynotes.lasteditedby, pos_deliverynotes.lasteditedon";
	$join="";
	$having="";
	$groupby="";
	$orderby="";
