...
{				
	...
	function add($obj){
		...
		if($teampaymentsDBO->persist($obj)){
			...
			$shpgeneraljournals[$it]=array('accountid'=>"$generaljournal->accountid", 'accountname'=>"$generaljournalaccounts->name",'documentno'=>"$generaljournal->documentno", 'memo'=>"$generaljournal->memo", 'remarks'=>"$generaljournal->remarks", 'debit'=>"$generaljournal->debit", 'credit'=>"$generaljournal->credit", 'total'=>"$generaljournal->total", 'transactdate'=>"$ob->transactdate",'balance'=>"$generaljournal->balance",'transactionid'=>"$generaljournal->transactionid");
