...
$fields="group_concat(distinct memo) memo ";
$join="";
$having="";
$groupby="";
$orderby="";
$where=" where documentno='$doc' and memo!=''";
...
<div style="font-size:11px !important;">PO Number: <?php echo $packinglists->memo; ?></div>
...
<tr><td colspan="9"><hr></td></tr>
	...
	<?php
		...
		$groupby=" ";
		$orderby=" ";
		$where="where documentno='$doc' and returns!=1";
...
// 	}
	...
	$box = mysql_fetch_object(mysql_query("select distinct boxno, count(*) cnt from pos_packinglists where documentno='$doc' and returns !=1"));
	?>
	 	    <tr><td colspan="9"><hr></td></tr> 
