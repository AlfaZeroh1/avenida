...
<tr><td colspan="8"><hr></td></tr>
	...
	<?php
		...
		$fields=" pos_packinglistdetails.itemid, count(distinct boxno) boxno,pos_packinglistdetails.memo,pos_sizes.name sizeid,sum(pos_packinglistdetails.quantity) quantity,pos_packinglists.id,pos_items.name,pos_categorys.name category ";
