...
//Authorization.
if(!empty($_GET['id'])){
	$auth->roleid="4013";//Edit
}
else{
	$auth->roleid="4011";//Add
}
...
if(!empty($id)){
	$categorys=new Categorys();
	$where=" where id=$id ";
	$fields="pos_categorys.id, pos_categorys.name, pos_categorys.departmentid, pos_categorys.remarks, pos_categorys.ipaddress, pos_categorys.createdby, pos_categorys.createdon, pos_categorys.lasteditedby, pos_categorys.lasteditedon";
	$join="";
	$having="";
	$groupby="";
	$orderby="";
