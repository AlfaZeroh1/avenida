<?php 
require_once("../../../DB.php");
class SalepaymentsDBO extends DB{
	var $fetchObject;
	var $sql;
	var $id;
	var $result;
	var $affectedRows;
 var $table="pos_salepayments";

	function persist($obj){
		$sql="insert into pos_salepayments(id,documentno,invoiceno,customerid,amount,paymentmodeid,bankid,chequeno,paidon,offsetid,createdby,createdon,lasteditedby,lasteditedon,ipaddress)
	...
	function delete($obj,$where=""){			
		...
		$sql="delete from pos_salepayments $where ";
		$this->sql=$sql;
		if(mysql_query($sql,$this->connection))		
				return true;	
	}			
	...
	function retrieve($fields,$join,$where,$having,$groupby,$orderby){			
		$sql="select $fields from pos_salepayments $join $where $groupby $having $orderby"; 
 		$this->sql=$sql;
