...
// logging("ID# ".$i);
  ...
  $shporders1=array_slice($shporders,0,$i);//logging(serialize($shporders1));
  $shporders2=array_slice($shporders,$i+1);//logging(serialize($shporders2));
  $shporders=array_merge($shporders1,$shporders2);//logging(serialize($shporders));
