...
function setShop(itemid, warmth){//alert("");
  var quantity = $("#"+itemid+"-"+warmth).val();//console.log(quantity);
//   alert("");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>
        <button id="warmth" onclick="clickWarmthModal(3);" type="button" style="height:60px;font-size:22px;" class="btn btn-info">WET FRY</button>
        <button id="warmth" onclick="clickWarmthModal(4);" type="button" style="height:60px;font-size:22px;" class="btn btn-warning">DRY FRY</button>
