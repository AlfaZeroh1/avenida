...
<form class="forms" id="theform" action="addshifts_proc.php" name="shifts" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right"></td>
		<td><input type="hidden" name="type" value="<?php echo $obj->type; ?>"/></td>
	</tr>
	<tr>
		<td align="right">Start Date : </td>
		<td><input type="text" name="starttime" id="starttime" size="20" readonly  value="<?php echo $obj->starttime; ?>"></td>
	</tr>
	<tr>
		<td align="right">End Date : </td>
		<td><input type="text" name="enddate" id="enddate" size="20" readonly  value="<?php echo $obj->enddate; ?>"></td>
	</tr>
	<tr>
