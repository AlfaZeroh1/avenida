...
//  		"sPaginationType": "full_numbers",
		...
		"fnRowCallback": function( nRow, aaData, iDisplayIndex ) {
			...
			$('td:eq(8)', nRow).html("<a href='#' onclick='showPopWin(&quot;addpatients_proc.php?id="+aaData[0]+"&quot;, 600, 510);'><img src='../view.png' alt='view' title='view' />");
