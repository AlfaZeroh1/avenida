<title>WiseDigits: Vitalsigns </title>
<?php 
$pop=1;
include "../../../head.php";
...
<form action="addvitalsigns_proc.php" name="vitalsigns" class="forms" method="POST" enctype="multipart/form-data">
