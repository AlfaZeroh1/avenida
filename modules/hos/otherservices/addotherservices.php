<title>WiseDigits ERP: Otherservices </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addotherservices_proc.php" name="otherservices" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Normal Charge : </td>
		<td><input type="text" name="charge" id="charge" size="8"  value="<?php echo $obj->charge; ?>"></td>
	</tr>
	<tr>
		<td align="right">NSSF Charge : </td>
		<td><input type="text" name="nssfcharge" id="nssfcharge" size="8"  value="<?php echo $obj->nssfcharge; ?>"></td>
	</tr>
	<tr>
