...
if(existsRule($auth)){
?>
<div style="float:left;" class="buttons"> <input onclick="showPopWin('addpatientvitalsigns_proc.php',600,430);" value="Add Patientvitalsigns " type="button"/></div>
<?php }?>
...
<?php } ?>
	...
	?>
		<tr>
			...
			<td><?php echo $row->patientappointmentid; ?></td>
