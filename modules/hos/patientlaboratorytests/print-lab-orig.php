...
$fields=" concat(hos_patients.surname,' ', hos_patients.othernames) as name,sys_genders.name as gender, hos_patientlaboratorytests.testedon,hos_patientlaboratorytests.patienttreatmentid,hos_patients.dob  ";
...
<span style="display:block; padding:0px 0px 1px;">Tel: <?php echo $arr['companytel'];?></span> </div>
 ...
 <tr>
  <td align="left"><strong>Gender:</strong>&nbsp;&nbsp;<?php echo $patient->gender; ?></td> 
 </tr>
<tr>
 <td align="left"><strong>Technologist:</strong>&nbsp;&nbsp;<?php $emp=mysql_fetch_object(mysql_query("select h.firstname from hrm_employees h left join auth_users u on h.id=u.employeeid left join hos_patientlaboratorytests t on t.createdby=u.id where t.testno='$testno'")); echo $emp->firstname; ?></td>
 </tr>
 <!--<tr>
 <td align="left"><strong>Doctor:</strong>&nbsp;&nbsp;<?php $emp=mysql_fetch_object(mysql_query("select h.firstname from hrm_employees h left join auth_users u on h.id=u.employeeid left join hos_patienttreatments t on t.createdby=u.id where t.testno='$testno'")); echo $emp->firstname; ?></td>
 </tr>-->
 <tr>
 </table>
 <hr/></div>
