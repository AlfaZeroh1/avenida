<title>WiseDigits ERP: Employeepaidarrears </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form class="forms" id="theform" action="addemployeepaidarrears_proc.php" name="employeepaidarrears" method="POST" enctype="multipart/form-data">
