<title>WiseDigits ERP: Arrears </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addarrears_proc.php" name="arrears" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><select name='taxable' class="selectbox">
			<option value='Yes' <?php if($obj->taxable=='Yes'){echo"selected";}?>>Yes</option>
			<option value='No' <?php if($obj->taxable=='No'){echo"selected";}?>>No</option>
		</select></td>
	</tr>
	<tr>
