...
<tbody>
	<?php
		...
		$where=" and hrm_assignments.departmentid = $obj->departmentid";
		if (!empty($obj->levelid))
		$where=" and hrm_assignments.levelid = $obj->levelid";
...
// 		  $amount = $row->basic*12*$employeeovertimes->hours*$rw->value/(365*8);
		  ...
		  $arr=array('employeeid'=>$row->id, 'overtimeid'=>$rw->id, 'month'=>$obj->month, 'year'=>$obj->year,'fromdate'=>"$obj->fromdate", 'todate'=>"$obj->todate");
