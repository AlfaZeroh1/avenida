<title>WiseDigits ERP: Leaves </title>
<?php 
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addleaves_proc.php" name="leaves" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Allowance To Cash : </td>
			<td><select name="allowanceid" class="selectbox">
