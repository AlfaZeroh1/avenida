<title>WiseDigits ERP: Inwarddetails </title>
<?php 
...
<div class='main'>
<form  id="theform" action="addinwarddetails_proc.php" name="inwarddetails" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Inward : </td>
			<td><select name="inwardid" class="selectbox">
...
<?php
	...
	while($rw=mysql_fetch_object($inwards->result)){
	?>
		<option value="<?php echo $rw->id; ?>" <?php if($obj->inwardid==$rw->id){echo "selected";}?>><?php echo initialCap($rw->name);?></option>
	<?php
	}
	?>
