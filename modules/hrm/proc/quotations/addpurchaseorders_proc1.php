...
if($obj->action2=="Add"){
	...
	;
	$shppurchaseorders[$it]=array('quantity'=>"$obj->quantity", 'itemid'=>"$obj->itemid", 'itemname'=>"$items->name", 'unitofmeasureid'=>"$obj->unitofmeasureid", 'unitofmeasurename'=>"$unitofmeasures->name", 'code'=>"$obj->code", 'vatclasseid'=>"$obj->vatclasseid", 'taxamount'=>"$obj->taxamount", 'tax'=>"$obj->tax", 'costprice'=>"$obj->costprice", 'tradeprice'=>"$obj->tradeprice", 'remarks'=>"$obj->remarks", 'total'=>"$obj->total");
...
if($obj->action=="Filter"){
	if(!empty($obj->invoiceno)){
		$purchaseorders = new Purchaseorders();
		$fields="proc_purchaseorderdetails.id, con_projects.id as projectid, proc_purchaseorders.currencyid, proc_purchaseorders.rate, proc_purchaseorders.eurorate, proc_purchaseorderdetails.unitofmeasureid, proc_purchaseorderdetails.total, proc_purchaseorderdetails.vatclasseid, proc_purchaseorderdetails.tax, proc_purchaseorderdetails.taxamount, inv_unitofmeasures.name unitofmeasurename, proc_purchaseorders.documentno, inv_items.id as itemid,inv_items.name itemname,  proc_purchaseorderdetails.quantity, proc_purchaseorderdetails.costprice, proc_purchaseorderdetails.total, proc_purchaseorderdetails.memo, proc_purchaseorders.requisitionno, proc_suppliers.id as supplierid, proc_purchaseorders.remarks, proc_purchaseorders.orderedon, proc_purchaseorders.file, proc_purchaseorders.createdby, proc_purchaseorders.createdon, proc_purchaseorders.lasteditedby, proc_purchaseorders.lasteditedon, proc_purchaseorders.ipaddress";
