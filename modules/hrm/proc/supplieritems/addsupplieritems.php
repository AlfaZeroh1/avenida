<title>WiseDigits ERP: Supplieritems </title>
<?php 
...
<div class='main'>
<form  id="theform" action="addsupplieritems_proc.php" name="supplieritems" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		...
		<td><input type="text" name="price" id="price" size="8"  value="<?php echo $obj->price; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
