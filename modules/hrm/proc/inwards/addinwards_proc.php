  ...
  while($i<$num){
    ...
    while($row=mysql_fetch_object($res)){
		...
		while($x<$quantity){
		  ...
		  $shpinwards[$it]=array('id'=>false,'checked'=>$checked,'purchaseorderdetailid'=>"$row->purchaseorderdetailid",'quantity'=>"1",'quantitys'=>"1", 'itemid'=>"$row->itemid", 'itemname'=>"$items->name",'assetid'=>"$row->assetid", 'assetname'=>"$row->assetname", 'categoryid'=>"$items->categoryid", 'package'=>"$items->package", 'categoryname'=>"$items->category", 'code'=>"$row->code",'discount'=>"$row->discount", 'discountamount'=>"$row->discountamount", 'tax'=>"$row->tax", 'vatclasseid'=>"$row->vatclasseid", 'vatamount'=>"$vatamount", 'costprice'=>"$row->costprice", 'tradeprice'=>"$row->tradeprice", 'remarks'=>"$row->remarks", 'total'=>"$row->total",'createdby'=>"$obj->createdby",'createdon'=>"$obj->createdon");
		...
		$shpinwards[$it]=array('id'=>false,'checked'=>$checked,'purchaseorderdetailid'=>"$row->purchaseorderdetailid",'quantity'=>"$quantity",'quantitys'=>"$row->quantity", 'itemid'=>"$row->itemid", 'itemname'=>"$items->name",'assetid'=>"$row->assetid", 'assetname'=>"$row->assetname", 'categoryid'=>"$items->categoryid", 'categoryname'=>"$items->category", 'package'=>"$items->package", 'code'=>"$row->code",'discount'=>"$row->discount", 'discountamount'=>"$row->discountamount", 'tax'=>"$row->tax", 'vatclasseid'=>"$row->vatclasseid", 'vatamount'=>"$vatamount", 'costprice'=>"$row->costprice", 'tradeprice'=>"$row->tradeprice", 'remarks'=>"$row->remarks", 'total'=>"$row->total",'createdby'=>"$obj->createdby",'createdon'=>"$obj->createdon");
