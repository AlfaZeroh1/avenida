<title>WiseDigits: Employeeclockings </title>
<?php 
...
<div class='main'>
<form  id="theform" action="addemployeeclockings_proc.php" name="employeeclockings" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Today Is? : </td>
		<td><input type="text" name="today" id="today" class="date_input" size="12" readonly  value="<?php echo $obj->today; ?>"></td>
	</tr>
	<tr>
