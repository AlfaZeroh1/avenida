<title>WiseDigits: Employeedisplinarys </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addemployeedisplinarys_proc.php" name="employeedisplinarys" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		<td align="right">Disciplinary Type : </td>
			<td><select name="disciplinarytypeid">
<option value="">Select...</option>
<?php
	...
	<tr>
		<td align="right">Disciplinary Date : </td>
		<td><input type="text" name="disciplinarydate" id="disciplinarydate" class="date_input" size="12" readonly  value="<?php echo $obj->disciplinarydate; ?>"></td>
	</tr>
	<tr>
