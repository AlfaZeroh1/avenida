<title>WiseDigits ERP: Overtimes </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addovertimes_proc.php" name="overtimes" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" name="hrs" id="hrs" size="8"  value="<?php echo $obj->hrs; ?>"></td>
	</tr>
	<tr>
