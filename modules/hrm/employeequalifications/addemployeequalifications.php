<title>WiseDigits: Employeequalifications </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="addemployeequalifications_proc.php" name="employeequalifications" method="POST" enctype="multipart/form-data">
...
<?php
	...
	<tr>
		...
		<td><textarea name="institution"><?php echo $obj->institution; ?></textarea></td>
	</tr>
	<tr>
		<td align="right">Grade : </td>
			<td><select name="gradingid">
<option value="">Select...</option>
<?php
