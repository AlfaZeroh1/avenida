...
<form class="forms" id="theform" action="addemployeeoffs_proc.php" name="employeeoffs" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" name="day" id="day" value="<?php echo $obj->day; ?>"></td>
	</tr>
	<tr>
