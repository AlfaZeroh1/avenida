<title>WiseDigits: Specialemployees </title>
<?php 
$pop=1;
include "../../../head.php";
...
<form action="addspecialemployees_proc.php" name="specialemployees"  method="POST" enctype="multipart/form-data">
	...
	<tr>
		...
		<td><input type="text" name="nhif" id="nhif" value="<?php echo $obj->nhif; ?>"></td>
	</tr>
	<tr>
		<td align="right">NSSF : </td>
		<td><input type="text" name="nssf" id="nssf" value="<?php echo $obj->nssf; ?>"></td>
	</tr>
	<tr>
