...
if(empty($obj->action)){
	...
	$roles= new Roles();
	$fields="auth_roles.id, auth_roles.name, auth_roles.moduleid, auth_roles.module, auth_roles.createdby, auth_roles.createdon, auth_roles.lasteditedby, auth_roles.lasteditedon, auth_roles.ipaddress";
	$join="";
	$having="";
	$groupby="";
	$orderby="";
