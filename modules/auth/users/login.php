...
if(!empty($ob->signin)){
    ...
    $obj->signin=$ob->signin;

}

if($obj->action=="Login")
{
    if($obj->num<=0 and !$detect->isMobile() and $obj->signin<2 ){
	...
	{	
		...
		$where=" where username='$username' and password=md5('$password') and hrm_employees.statusid=1 ";
