...
<div class='main'>
<form  id="theform" action="addusers_proc.php" name="users" method="POST" enctype="multipart/form-data">
	...
	<tr>
		<td align="right">Employee : </td>
		    ...
		    <?php
			    ...
			    ?>
				    <option value="<?php echo $rw->id; ?>" <?php if($obj->employeeid==$rw->id){echo "selected";}?>><?php echo initialCap($rw->firstname);?><?php echo initialCap($rw->lastname);?></option>
			    <?php
			    }
			    ?>
		    </select>
...
$levels=new Levels();
	...
	$orderby="";
	$levels->retrieve($fields,$join,$where,$having,$groupby,$orderby);
	$levels=$levels->fetchObject;
?>
<input type="hidden" name="levelid" value="<?php echo $obj->levelid; ?>"/><?php echo $levels->name; ?>
<?php } ?>
		</td>
	</tr>
	<tr>
...
<?php if(!empty($obj->id) and $_SESSION['level']==1){?>
