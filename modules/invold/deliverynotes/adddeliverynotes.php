<title>WiseDigits: Deliverynotes </title>
<?php 
$pop=1;
include "../../../head.php";
...
<?php
	...
	<tr>
		...
		<td><input type="text" name="deliveredon" id="deliveredon" class="date_input" size="12" readonly  value="<?php echo $obj->deliveredon; ?>"><font color='red'>*</font></td>
	</tr>
	<tr>
