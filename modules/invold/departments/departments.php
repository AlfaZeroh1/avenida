...
<?php } ?>
	...
	<?php
		$i=0;
		$fields="inv_departments.id, inv_departments.name, inv_departments.code, inv_departments.remarks, inv_departments.createdby, inv_departments.createdon, inv_departments.lasteditedby, inv_departments.lasteditedon, inv_departments.ipaddress, hrm_departments.name departmentid";
		$join=" left join hrm_departments on hrm_departments.id=inv_departments.departmentid ";
		$having="";
		$groupby="";
		$orderby="";
