<title>WiseDigits ERP: Departments </title>
<?php 
$pop=1;
include "../../../head.php";
...
<div class='main'>
<form  id="theform" action="adddepartments_proc.php" name="departments" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><select name="departmentid" class="selectbox">
		      ...
		      <?php
		      $res=mysql_query("select * from hrm_departments");
