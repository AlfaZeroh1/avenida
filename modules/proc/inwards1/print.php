...
<span style="display:block; padding:0px 0px 1px;">Tel: <?php echo $_SESSION['companytel'];?></span> </div>
 ...
 <span style="display:block; padding:3px 10px; font-size:16px; text-align:center; font-weight:bold; color:#fff; background-color:#999">GOODS RECEIVED NOTE</span></div>
 
<!-- <div class="hfields" align="left" style="float:left; width:100%; padding-left:5px;">-->
 <hr/>
  <table width="100%">
<td><strong>GRN No: <?php echo $orders->documentno; ?></strong></td><td><strong>GRN Date: <?php echo formatDate($orders->inwarddate); ?></strong></td>
<td><strong>LPO No: <?php echo $orders->lpono; ?></strong></td>
 ...
 <td colspan="5">
  ...
  <div class="hfields" align="left" style="float:left; width:100%; padding-left:5px;">
 <strong>Received From</strong>:<br/> <?php echo initialCap($suppliers->name); ?><br/>
