...
$fields=" *, sys_currencys.name currency, concat(hrm_employees.firstname,' ',concat(hrm_employees.middlename,' ',hrm_employees.lastname)) employeeid ";
 ...
 <table width="100%" class="table-stripped table-bordered table"  style="line-height:7px;font-size:7px;  margin: 0px auto;  padding: 0; border-spacing: none;" cellspacing="0" cellpadding="0">
  ...
  <thead>
	...
	$purchaseorders = new Purchaseorders();
		$fields="proc_purchaseorders.id, con_projects.name as projectid, proc_purchaseorders.documentno, inv_unitofmeasures.name uom, inv_items.id as itemid,inv_items.name itemname, fn_expenses.name expensename, proc_purchaseorderdetails.expenseid, proc_purchaseorderdetails.tax,  proc_purchaseorderdetails.quantity, proc_purchaseorderdetails.costprice, proc_purchaseorderdetails.total,proc_purchaseorderdetails.discount, proc_purchaseorderdetails.discountamount, proc_purchaseorderdetails.memo, proc_purchaseorders.requisitionno, proc_suppliers.id as supplierid, proc_purchaseorders.remarks, proc_purchaseorders.orderedon, proc_purchaseorders.file, proc_purchaseorders.createdby, proc_purchaseorders.createdon, proc_purchaseorders.lasteditedby, proc_purchaseorders.lasteditedon, proc_purchaseorders.ipaddress,assets_categorys.id as categoryid, assets_categorys.name assetname, inv_items.package";
		...
		<tr style="font-size:7px !important;">
			...
			<td align="center" cellspacing="0"><div align="center"><?php echo getQntPackage($row->package,$row->quantity); ?></div></td>
			<td align="center" cellspacing="0"><?php echo $row->uom; ?></td>
			<td align="right" cellspacing="0"><div align="right"><?php echo formatNumber(getPricePackage($row->package,$row->costprice)); ?></div></td>
