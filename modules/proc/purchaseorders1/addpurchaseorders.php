...
<form  id="theform" action="addpurchaseorders_proc.php" name="purchaseorders" method="POST" enctype="multipart/form-data">
	<table ?php if($obj->status==2){ ?> style="background-image:url(../../../images/cancel.png); background-repeat:no-repeat;"  <?php } ?> width="100%" border="0" align="center" cellpadding="2" cellspacing="0"  >
