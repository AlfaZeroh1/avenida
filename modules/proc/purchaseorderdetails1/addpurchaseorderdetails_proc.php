...
if(!empty($id)){
	$purchaseorderdetails=new Purchaseorderdetails();
	$where=" where id=$id ";
	$fields="proc_purchaseorderdetails.id, proc_purchaseorderdetails.purchaseorderid, proc_purchaseorderdetails.itemid, proc_purchaseorderdetails.quantity, proc_purchaseorderdetails.costprice, proc_purchaseorderdetails.tradeprice, proc_purchaseorderdetails.tax, proc_purchaseorderdetails.total, proc_purchaseorderdetails.memo,proc_purchaseorderdetails.categoryid, proc_purchaseorderdetails.ipaddress, proc_purchaseorderdetails.createdby, proc_purchaseorderdetails.createdon, proc_purchaseorderdetails.lasteditedby, proc_purchaseorderdetails.lasteditedon";
	$join="";
	$having="";
	$groupby="";
	$orderby="";
