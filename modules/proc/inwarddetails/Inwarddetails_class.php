...
// 					  $stocktrack->reduceStock($obj);
					...
					$branchstocks->recorddate=$obj->inwarddate;
					$branchstocks->quantity=$quantity;
					$branchstocks->quantitys=$quantity;
					$branchstocks->transactionid=$transaction->id;

					$branchstocks->transaction="GRN";
					
					if($branchstockss->affectedRows>0){
					  $branchstockss = $branchstockss->fetchObject;
					  
					  $branchstockss->quantity+=($quantity);
					  $branchstockss->quantitys=($quantity);
					  $branchstockss->recorddate=$obj->inwarddate;
					  $branchstockss->transaction="GRN";
