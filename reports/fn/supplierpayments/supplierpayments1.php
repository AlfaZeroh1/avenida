...
//processing columns to show
	...
	if(!empty($obj->shamount)  or empty($obj->action)){
		...
		if(!empty($rptgroup)){
			array_push($aColumns, "sum(fn_supplierpayments.amount) amount");
		}else{
		array_push($aColumns, "fn_supplierpayments.amount");
		}
	...
	if(!empty($obj->shcreatedby)  or empty($obj->action)){
		...
		array_push($aColumns, "fn_supplierpayments.createdby");
		$k++;
		}
