...
<div class="fnt">
		...
		$having="";
		$where= " where fn_generaljournals.transactdate < '$obj->fromtransactdate' and fn_generaljournals.accountid in (select id from fn_generaljournals where categoryid='$obj->accountid' ";
		$groupby= "";
		$orderby="";
		...
		$join=" left join sys_transactions on sys_transactions.id=fn_generaljournals.transactionid left join sys_currencys on sys_currencys.id=fn_generaljournals.currencyid ";
		$having="";
		$where= " where fn_generaljournals.transactdate >= '$obj->fromtransactdate' and fn_generaljournals.transactdate <= '$obj->totransactdate' and fn_generaljournals.accountid in (select id from fn_generaljournals where categoryid='$obj->accountid'  ";
		$groupby= "";
   ...
   <tfoot>
	...
	<?php } ?>
	 <?php
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)<0 and fn_generaljournals.accountid  in (select id from fn_generaljournals where categoryid='$obj->accountid'  ";
		$groupby= "";
		$orderby="";
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)>0 and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)<=30 and fn_generaljournals.accountid  in (select id from fn_generaljournals where categoryid='$obj->accountid'  ";
		$groupby= "";
		$orderby="";
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)>30 and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)<=60 and fn_generaljournals.accountid in (select id from fn_generaljournals where categoryid='$obj->accountid'  ";
		$groupby= "";
		$orderby="";
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)>60 and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)<=90  and fn_generaljournals.accountid in (select id from fn_generaljournals where categoryid='$obj->accountid' ";
		$groupby= "";
		$orderby="";
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)>90  and fn_generaljournals.accountid in (select id from fn_generaljournals where categoryid='$obj->accountid'  ";
		$groupby= "";
		$orderby="";
