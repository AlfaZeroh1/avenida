...
?>
 ...
 <?php $_SESSION['sOrder']=" order by trim(fn_generaljournalaccounts.name) ";?>
...
//  			var perc =   1;
			...
			$('td:eq(2)', nRow).html(aaData[2]).formatCurrency().attr('align','right').addClass("bold");
			return nRow;
		},
		"fnFooterCallback": function ( nRow, aaData, iStart, iEnd, aiDisplay ) {
			...
			$('td:eq(2)', nRow).html(t7).formatCurrency().attr('align','right').addClass("gray");
		}
 	} );
 } );
 </script>
