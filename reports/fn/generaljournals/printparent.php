...
<div class="fnt">
			      ...
			      <th width="" align="center"><span style="text-decoration:underline;">Invoice</span></th>
		...
		$having="";
		$where= " where fn_generaljournals.transactdate < '$obj->fromtransactdate' and fn_generaljournals.accountid in(select id from fn_generaljournalaccounts where categoryid='$obj->accountid') and fn_generaljournals.transactdate>='2015-07-01' and fn_generaljournals.transactdate!='0000-00-00'";
		$groupby= "";
		$orderby="";
		...
		<tr>
			...
			<td colspan="2"><?php echo $row->memo; ?></td>
		...
		$join=" left join sys_transactions on sys_transactions.id=fn_generaljournals.transactionid left join sys_currencys on sys_currencys.id=fn_generaljournals.currencyid ";
		$having="";
		$where= " where fn_generaljournals.transactdate >= '$obj->fromtransactdate' and fn_generaljournals.transactdate <= '$obj->totransactdate' and fn_generaljournals.accountid in(select id from fn_generaljournalaccounts where categoryid='$obj->accountid')and fn_generaljournals.transactdate>='2015-07-01' and fn_generaljournals.transactdate!='0000-00-00' ";
		$groupby= " group by id ";
   ...
   <tfoot>
	...
	<?php } ?>
	 <?php
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)<0 and fn_generaljournals.accountid in(select id from fn_generaljournalaccounts where categoryid='$obj->accountid') and fn_generaljournals.transactdate>='2015-07-01' and fn_generaljournals.transactdate!='0000-00-00' ";
		$groupby= "";
		$orderby="";
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)>0 and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)<=30 and fn_generaljournals.accountid in(select id from fn_generaljournalaccounts where categoryid='$obj->accountid')and fn_generaljournals.transactdate>='2015-07-01' and fn_generaljournals.transactdate!='0000-00-00' ";
		$groupby= "";
		$orderby="";
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)>30 and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)<=60 and fn_generaljournals.accountid in(select id from fn_generaljournalaccounts where categoryid='$obj->accountid')and fn_generaljournals.transactdate>='2015-07-01' and fn_generaljournals.transactdate!='0000-00-00' ";
		$groupby= "";
		$orderby="";
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)>60 and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)<=90  and fn_generaljournals.accountid in(select id from fn_generaljournalaccounts where categoryid='$obj->accountid') and fn_generaljournals.transactdate>='2015-07-01' and fn_generaljournals.transactdate!='0000-00-00' ";
		$groupby= "";
		$orderby="";
		...
		$join="";
		$having="";
		$where= " where fn_generaljournals.transactdate <= '$obj->totransactdate' and (DATEDIFF('$obj->totransactdate',transactdate)+$customers->creditdays)>90  and fn_generaljournals.accountid in(select id from fn_generaljournalaccounts where categoryid='$obj->accountid') and fn_generaljournals.transactdate>='2015-07-01' and fn_generaljournals.transactdate!='0000-00-00'";
		$groupby= "";
		$orderby="";
