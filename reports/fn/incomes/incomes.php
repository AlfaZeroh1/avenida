...
//processing columns to show
	if(!empty($obj->shname)  or empty($obj->action)){
		...
		array_push($aColumns, "fn_incomes.name");
	}

	if(!empty($obj->shcode)  or empty($obj->action)){
		array_push($sColumns, 'code');
		array_push($aColumns, "fn_incomes.code");
	}

	if(!empty($obj->shremarks) ){
		array_push($sColumns, 'remarks');
		array_push($aColumns, "fn_incomes.remarks");
	}

	if(!empty($obj->shcreatedon)  or empty($obj->action)){
		array_push($sColumns, 'createdon');
		array_push($aColumns, "fn_incomes.createdon");
	}

	if(!empty($obj->shcreatedby)  or empty($obj->action)){
		array_push($sColumns, 'createdby');
		array_push($aColumns, "fn_incomes.createdby");
	}

	if(!empty($obj->shipaddress) ){
		array_push($sColumns, 'ipaddress');
		array_push($aColumns, "fn_incomes.ipaddress");
	}
...
if(!empty($obj->name)){
	if($track>0)
		$rptwhere.="and";
		$rptwhere.=" fn_incomes.name='$obj->name'";
	$track++;
}
...
if(!empty($obj->code)){
	if($track>0)
		$rptwhere.="and";
		$rptwhere.=" fn_incomes.code='$obj->code'";
	$track++;
}
...
if(!empty($obj->fromcreatedon)){
	if($track>0)
		$rptwhere.="and";
		$rptwhere.=" fn_incomes.createdon>='$obj->fromcreatedon'";
	$track++;
}
...
if(!empty($obj->tocreatedon)){
	if($track>0)
		$rptwhere.="and";
		$rptwhere.=" fn_incomes.createdon<='$obj->tocreatedon'";
	$track++;
}
...
if(!empty($obj->createdby)){
	if($track>0)
		$rptwhere.="and";
		$rptwhere.=" fn_incomes.createdby='$obj->createdby'";
	$track++;
}
...
<script type="text/javascript" charset="utf-8">
 ...
 <?php $_SESSION['sTable']="fn_incomes";?>
 <?php $_SESSION['sOrder']="";?>
 ...
 $(document).ready(function() {
 	...
 	$('#tbl').dataTable( {
		...
		"bJQueryUI": true,
		"bRetrieve":true,
		"sAjaxSource": "../../../modules/server/server/processing.php?sTable=fn_incomes",
...
<form  action="incomes.php" method="post" name="incomes" class='forms'>
