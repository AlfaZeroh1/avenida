...
//processing columns to show
	...
	if(!empty($obj->shconsigneeid)  or empty($obj->action)){
	...
	if(!empty($obj->shcreatedby)  or empty($obj->action)){
		...
		$rptjoin.=" left join auth_users on auth_users.id=pos_orders.lasteditedby ";
		$k++;
		}
...
<form  action="orderss.php" method="post" name="orders" >
