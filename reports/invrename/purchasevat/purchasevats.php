...
$aColumns = array('1','name','pinno','vatno','etrno','transactdate','documentno','receiptno','country', 'remarks','gross','vatamount','net');
$sColumns = array('1','name','pinno','vatno','etrno','transactdate','documentno','receiptno','country', 'remarks','gross','vatamount','net');
$rptjoin="";
...
<script type="text/javascript" charset="utf-8">
 ...
 <?php $_SESSION['sTable']="purchasevats";?>
 ...
 $(document).ready(function() {
 	...
 	$('#tbl').dataTable( {
		...
		"bJQueryUI": true,
		"bRetrieve":true,
		"sAjaxSource": "../../../modules/server/server/processing.php?sTable=purchasevats",
...
<?php }?>
<form  action="purchasevats.php" class="forms" method="post" name="Sales Vats">
<table>
