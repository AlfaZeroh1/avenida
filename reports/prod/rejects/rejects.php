...
// 		}
	...
	if(!empty($obj->shemployeeid)  or empty($obj->action)){
		...
		array_push($aColumns, "prod_rejects.employeeid");
		$k++;
		}
	...
	if(!empty($obj->shharvestedon)){
		...
		array_push($aColumns, "prod_rejects.harvestedon");
		$k++;
		}
...
<form  action="rejects.php" method="post" name="rejects" >
	...
	<tr>
		...
		<table class="tgrid gridd" border="0" align="right">
			...
			<tr>
			  ...
			  <select name="reduce" class="selectbox">
			    ...
			    <option value="reduce">Pre-cool Store</option>
			  </select>
			  </td>
			</tr>
		</table>
		...
		<table class="tgrid gridd" width="100%" border="0" align="left">
			...
			<tr>	
				...
				<td><input type='checkbox' name='shharvestedon' value='1' <?php if(isset($_POST['shharvestedon']) ){echo"checked";}?>>&nbsp;Harvested on</td>
			<tr>	
