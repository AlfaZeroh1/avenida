...
if(empty($obj->action)){
	$obj->fromplantedon=date('Y-m-d');
	$obj->toplantedon=date('Y-m-d');
}
...
<table width="100%" border="0" align="center" id="tbl">
	<tr>
		...
		<table class="tgrid gridd" border="0" align="right">
			...
			<select name='createdby' class='selectbox'>
				...
				$where=" where auth_users.id in(select createdby from prod_plantings) ";
