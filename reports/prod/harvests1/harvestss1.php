...
if(!empty($obj->grgreenhouseid)){
	...
	$rptgroup.=" block,section,greenhouse ";
...
?>
 ...
 <?php $_SESSION['sGroup']="$rptgroup with rollup";?>
			...
			for(var i=0; i<aaData.length; i++){
			  ...
			  for(var j=<?php echo $mnt; ?>; j<aaData[i].length; j++){
			    ...
			    if(aaData[i][j]=='')
			      ...
			      if(i==0)
				total[j]=0;
				if(aaData[i][1]!="" && aaData[i][2]!="" && aaData[i][3]!="")
...
<table width="100%" border="0" align="center">
	<tr>
		...
		<table class="tgrid gridd" width="100%" border="0" align="left">
			...
			<tr>
				<td><input type='checkbox' name='grcreatedon' value='1' <?php if(isset($_POST['grcreatedon']) ){echo"checked";}?>>&nbsp;Date</td>
		</table>
		</td>
		</tr>
		<tr>
		...
		<!--<table class="tgrid gridd" width="100%" border="0" align="left">
			...
			<tr>
				...
				<td><input type='checkbox' name='shsizeid' value='1' <?php if(isset($_POST['shsizeid'])){echo"checked";}?>>&nbsp;Length</td>
			<tr>
				<td><input type='checkbox' name='shplantingdetailid' value='1' <?php if(isset($_POST['shplantingdetailid'])){echo"checked";}?>>&nbsp;Planting Details</td>
				<td><input type='checkbox' name='shgreenhouseid' value='1' <?php if(isset($_POST['shgreenhouseid'])){echo"checked";}?>>&nbsp;Block</td>
			<tr>
			...
			<tr>
				<td><input type='checkbox' name='shtypeid' value='1' <?php if(isset($_POST['shtypeid'])){echo"checked";}?>>&nbsp;Variety Type</td>
			...
			<tr>
				...
				<td><input type='checkbox' name='shcreatedon' value='1' <?php if(isset($_POST['shcreatedon']) ){echo"checked";}?>>&nbsp;Date</td>
		</table>-->
		</td>
	</tr>
	<tr>
