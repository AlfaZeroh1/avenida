...
//processing columns to show
	...
	if(!empty($obj->shipaddress) ){
		...
		array_push($aColumns, "prod_harvests.ipaddress");
		$k++;
		}
...
if(!empty($obj->greenhouseid)){
	if($track>0)
		$rptwhere.="and";
		$rptwhere.=" prod_harvests.greenhouseid='$obj->greenhouseid'";
...
<table width="100%" border="0" align="center">
	<tr>
		...
		<table class="tgrid gridd" border="0" align="right">
			...
			<tr>
				<td>Quantity</td>
				<td><input type='text' id='quantity' size='16' name='quantity' value='<?php echo $obj->quantity;?>'/></td>
			</tr>
			<tr>
				<td>Harvest Date</td>
		...
		<table class="tgrid gridd" width="100%" border="0" align="left">
			...
			<tr>
				<td><input type='checkbox' name='grgreenhouseid' value='1' <?php if(isset($_POST['grgreenhouseid']) ){echo"checked";}?>>&nbsp;Block</td>
		...
		<table class="tgrid gridd" width="100%" border="0" align="left">
			...
			<tr>
				...
				<td><input type='checkbox' name='shgreenhouseid' value='1' <?php if(isset($_POST['shgreenhouseid'])  or empty($obj->action)){echo"checked";}?>>&nbsp;Block</td>
			<tr>
