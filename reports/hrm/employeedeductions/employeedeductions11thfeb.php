...
if(!empty($obj->amount)){
	if($track>0)
		$rptwhere.="and";
		$rptwhere.=" hrm_employeedeductions.amount='$obj->amount'";
	$track++;
}
...
<form  action="employeedeductions.php" method="post" name="employeedeductions" class=''>
<table width="100%" border="0" align="center">
  ...
  ?>
			...
			<select name='createdby' class='selectbox'>
				...
				$where=" where auth_users.id in(select createdby from hrm_employeedeductions) ";
