...
if($obj->action=="Take Stock"){

  $query="truncate inv_branchstocks";
  mysql_query($query);
  $query="truncate inv_stocktrack";
  mysql_query($query);
  $query="truncate inv_stocktakedetails";
  mysql_query($query);
...
$rptwhere=" inv_items.status='Active' ";
$track++;
...
<table width="100%" border="0" align="center" class="table">
	...
	<tr>
		<td colspan="2" align='center'>
		  <input type="submit" class="btn btn-info" name="action" id="action" value="Filter" />
<!-- 		  <input type="submit" class="btn btn-danger" name="action" id="action" value="" /> -->
		</td>
	</tr>
</table>
</form>
